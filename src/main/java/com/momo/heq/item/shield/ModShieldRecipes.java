        ...
        public boolean matches(InventoryCrafting inv, World worldIn)
        {
            ...
            for (int i = 0; i < inv.getSizeInventory(); ++i)
            {
                ...
                if (!itemstack2.isEmpty())
                {
                    ...
                    {
                        if (itemstack2.getItem() != ModItems.DIAMOND_SHIELD && itemstack2.getItem() != ModItems.EMERALD_SHIELD
                                && itemstack2.getItem() != ModItems.GOLD_SHIELD && itemstack2.getItem() != ModItems.IRON_SHIELD)
                        {
                            return false;
                        }
