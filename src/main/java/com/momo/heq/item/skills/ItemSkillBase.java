package com.momo.heq.item.skills;

import com.momo.heq.MoMoFramework;
import com.momo.heq.item.ItemBase;
import com.momo.heq.util.CommonFunctions;
import com.momo.heq.util.IDLSkillNBT;
import com.momo.heq.util.MessageDef;
...
import static com.momo.heq.util.CommonDef.G_SKY;
import static com.momo.heq.util.CommonDef.TICK_PER_SECOND;
import static com.momo.heq.util.CommonFunctions.SendMsgToPlayer;
import static com.momo.heq.util.CommonFunctions.isShiftPressed;
import static com.momo.heq.util.MessageDef.getSkillCastKey;
