package com.momo.heq;

import com.momo.heq.gui.ModGuiElementLoader;
import com.momo.heq.init.*;
import com.momo.heq.keys.KeyboardManager;
import com.momo.heq.meta.MetaUtil;
import com.momo.heq.network.NetworkHandler;
import com.momo.heq.proxy.ProxyBase;
import com.momo.heq.util.CommonDef;
...
public class MoMoFramework {
    public static final String MODID = "heq";
    public static final String NAME = "heq";
